...
// Recorre archivo md y extrae links con su texto y url
          ...
          linksValidate.then(results =>{
              ...
              `;
                ...
                console.log(`El enlace "${result.text}" es válido. Estado: ${result.status}-${result.message}\n ${infoAdditional}`);
                validLinks.push(result);
                }else {
                  console.log(`El enlace "${result.text}" no es válido. Estado: ${result.status} - ${result.message}\n ${infoAdditional}`);
